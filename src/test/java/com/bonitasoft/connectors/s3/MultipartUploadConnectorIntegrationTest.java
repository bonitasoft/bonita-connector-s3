...
class MultipartUploadConnectorIntegrationTest {
    ...
    void shouldExecuteAgainstRealApi() throws Exception {
        ...
        inputs.put("objectKey", "integration-test/multipart-" + System.currentTimeMillis() + ".txt");
        inputs.put("fileContentBase64", Base64.getEncoder().encodeToString(
                "Multipart upload integration test content".getBytes()));
